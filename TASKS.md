...
- [ ] 新手轨难度下调：三关球速放慢（1.9/1.6/1.3s）、失误率上调（25/15/8%）、反应放宽（280/230/180ms）；扣杀飞行时间按关卡可配（新手王冠 0.95s）
- [ ] 扣球跳起更夸张：跳跃峰值与落地压缩加大，与普通击打隔屏可辨
- [ ] 引导简图左右对照：左侧手部动作 + 右侧简笔小人同步演示游戏内结果（握一下=挥拍、握两下=跳扣且动作更快）
