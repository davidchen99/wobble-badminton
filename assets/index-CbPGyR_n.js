...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new q(0,1,0);return new Ci({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Ci({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Ci({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
...
马上开球…`;case`done`:return``}}goto(e){this.step=e,this.onStepChange?.(e)}},Pl=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[17,18],[18,19],[19,20],[0,17]],Fl=[{key:`swingSpeedThreshold`,label:`挥拍速度阈值`,min:.5,max:4,step:.1},{key:`cooldownMs`,label:`冷却 (ms)`,min:100,max:800,step:10},{key:`smoothing`,label:`平滑`,min:.1,max:.9,step:.05}],Il=class{gesture;panelEl;statsEl;controlsEl;overlay;ctx;swingFlashUntil=0;constructor(e){this.gesture=e,this.panelEl=Ll(`debug-panel`),this.statsEl=Ll(`debug-stats`),this.controlsEl=Ll(`debug-controls`),this.overlay=Ll(`cam-overlay`);let t=this.overlay.getContext(`2d`);if(!t)throw Error(`无法创建 debug 画布上下文`);this.ctx=t,this.addSliders(Fl.map(e=>({...e,get:()=>this.gesture.params[e.key],set:t=>{this.gesture.params[e.key]=t}})))}get visible(){return!this.panelEl.hidden}toggle(){this.panelEl.hidden=!this.panelEl.hidden}addSliders(e){for(let t of e){let e=document.createElement(`label`);e.className=`debug-slider`;let n=document.createElement(`span`);n.textContent=t.label;let r=document.createElement(`span`);r.className=`debug-slider-value`;let i=document.createElement(`input`);i.type=`range`,i.min=String(t.min),i.max=String(t.max),i.step=String(t.step),i.value=String(t.get());let a=()=>{r.textContent=t.get().toFixed(t.step<.1?2:1)};i.addEventListener(`input`,()=>{t.set(Number(i.value)),a()}),a(),e.append(n,i,r),this.controlsEl.appendChild(e)}}updateStats(e){let t=e.velocity,n=[`render FPS : ${e.renderFps.toFixed(0)}`,`track FPS  : ${e.trackingFps.toFixed(0)} (${e.delegate??`--`} ${e.inferMs.toFixed(0)}ms/帧, 间隔${e.detectIntervalMs.toFixed(0)}ms)`,`confidence : ${e.confidence===null?`--`:e.confidence.toFixed(2)}`,`wrist vel  : ${t.x.toFixed(2)}, ${t.y.toFixed(2)} (|v|=${Math.hypot(t.x,t.y).toFixed(2)})`,`cooldown   : ${e.cooldownActive?`active`:`ready`}`,`swing      : ${e.lastSwing?`${e.lastSwing.direction} @ ${e.lastSwing.speed.toFixed(1)}`:`--`}`];this.statsEl.textContent=n.join(`
`)}flashSwing(){this.swingFlashUntil=performance.now()+250}drawOverlay(e){let{width:t,height:n}=this.overlay,r=this.ctx;r.clearRect(0,0,t,n);let i=this.gesture.trail;if(i.length>1&&(r.strokeStyle=`rgba(255, 210, 63, 0.85)`,r.lineWidth=2,r.beginPath(),i.forEach((e,i)=>{let a=e.x*t,o=e.y*n;i===0?r.moveTo(a,o):r.lineTo(a,o)}),r.stroke()),e){r.strokeStyle=`rgba(120, 220, 120, 0.9)`,r.lineWidth=1.5,r.beginPath();for(let[i,a]of Pl)r.moveTo(e.landmarks[i].x*t,e.landmarks[i].y*n),r.lineTo(e.landmarks[a].x*t,e.landmarks[a].y*n);r.stroke(),r.fillStyle=`rgba(120, 220, 120, 0.9)`;for(let i of e.landmarks)r.beginPath(),r.arc(i.x*t,i.y*n,2,0,Math.PI*2),r.fill();r.fillStyle=`#ffd23f`,r.beginPath(),r.arc(e.palm.x*t,e.palm.y*n,4,0,Math.PI*2),r.fill()}performance.now()<this.swingFlashUntil&&(r.fillStyle=`rgba(255, 90, 90, 0.25)`,r.fillRect(0,0,t,n),r.fillStyle=`#ff5a5a`,r.font=`bold 16px system-ui`,r.fillText(`SWING!`,8,22))}};function Ll(e){let t=document.getElementById(e);if(!t)throw Error(`Debug 面板缺少 #${e} 元素`);return t}var Rl=`#e8eaee`,zl=`#ffd23f`;function Bl(e,t,n,r,i=1){if(e.save(),e.translate(t,n),e.scale(i,i),e.strokeStyle=Rl,e.fillStyle=Rl,e.lineWidth=3,e.lineCap=`round`,e.beginPath(),e.arc(0,4,13,0,Math.PI*2),e.stroke(),r>.5){for(let t=0;t<4;t++){let n=-10+t*6.5;e.beginPath(),e.moveTo(n,-6),e.lineTo(n,-20),e.stroke()}e.beginPath(),e.moveTo(-12,4),e.lineTo(-20,-2),e.stroke()}else{for(let t=0;t<4;t++){let n=-9+t*6.2;e.beginPath(),e.arc(n,-8,3.4,0,Math.PI*2),e.fill()}e.beginPath(),e.moveTo(-13,0),e.lineTo(-6,6),e.stroke()}e.restore()}function Vl(e,t){let n=e%t/t;return n<.4?1:n<.6?1-(n-.4)/.2:0}function Hl(e,t,n,r,i){e.clearRect(0,0,r,i);let a=r/2,o=i/2;switch(t){case`showHand`:{Bl(e,a,o,1,1.2);let t=n%1*26+18;e.strokeStyle=`rgba(120, 220, 120, ${1-n%1})`,e.lineWidth=2,e.beginPath(),e.arc(a,o,t,0,Math.PI*2),e.stroke();break}case`fist`:Bl(e,a,o,Vl(n,1.4),1.2);break;case`doubleFist`:Bl(e,a,o,Vl(n,.7),1.2),e.fillStyle=zl,e.font=`bold 18px system-ui`,e.textAlign=`center`,e.fillText(`×2`,a+34,o-18);break;case`move`:Bl(e,a+Math.sin(n*1.6)*22,o,1,1.1),e.fillStyle=zl;for(let t of[-1,1]){let n=a+t*46;e.beginPath(),e.moveTo(n+t*8,o-8),e.lineTo(n-t*8,o),e.lineTo(n+t*8,o+8),e.closePath(),e.fill()}break;case`wave`:{let t=Math.sin(n*5)*26;e.globalAlpha=.25,Bl(e,a+Math.sin(n*5-.35)*26,o,1,1.1),e.globalAlpha=.5,Bl(e,a+Math.sin(n*5-.18)*26,o,1,1.1),e.globalAlpha=1,Bl(e,a+t,o,1,1.1);break}}}function Ul(e,t,n=1){let r=e.getContext(`2d`);if(!r)return()=>void 0;let i=0,a=performance.now(),o=()=>{r.save(),r.translate(e.width/2,e.height/2),r.scale(n,n),r.translate(-e.width/2,-e.height/2),Hl(r,t,(performance.now()-a)/1e3,e.width,e.height),r.restore(),i=requestAnimationFrame(o)};return i=requestAnimationFrame(o),()=>cancelAnimationFrame(i)}var Wl=[{title:`模式一 · 空手（默认）`,sketch:`fist`,lines:[`握拳 = 击打`,`连握两次 = 扣球`,`手左右移 = 跑位`,`手往前伸/收回 = 前后移动`]},{title:`模式二 · 键盘+持物（M 切换）`,sketch:`wave`,lines:[`W A S D = 前后左右移动`,`手持遥控器/拍子快速挥动 = 击打`]},{title:`通用`,sketch:null,lines:[`空格 暂停/继续`,`R 重新开局`,`M 切换操控模式`,`H 或 F1 打开/关闭本帮助`]}],Gl=class{overlay;stopSketches=[];constructor(e){this.overlay=Kl(`help-overlay`);let t=Kl(`help-sections`);for(let e of Wl){let n=document.createElement(`div`);n.className=`help-card-section`;let r=document.createElement(`h3`);if(r.textContent=e.title,n.appendChild(r),e.sketch){let t=document.createElement(`canvas`);t.width=110,t.height=110,t.className=`help-sketch`,t.dataset.sketch=e.sketch,n.appendChild(t)}let i=document.createElement(`ul`);for(let t of e.lines){let e=document.createElement(`li`);e.textContent=t,i.appendChild(e)}n.appendChild(i),t.appendChild(n)}Kl(`help-btn`).addEventListener(`click`,e=>{e.stopPropagation(),this.toggle()}),Kl(`help-close`).addEventListener(`click`,()=>this.hide()),Kl(`help-tutorial`).addEventListener(`click`,()=>{this.hide(),e()}),this.overlay.addEventListener(`click`,e=>{e.target===this.overlay&&this.hide()})}get isOpen(){return!this.overlay.hidden}show(){this.overlay.hidden=!1,this.stopSketches=Array.from(this.overlay.querySelectorAll(`canvas.help-sketch`)).map(e=>Ul(e,e.dataset.sketch))}hide(){this.overlay.hidden=!0,this.stopSketches.forEach(e=>e()),this.stopSketches=[]}toggle(){this.isOpen?this.hide():this.show()}};function Kl(e){let t=document.getElementById(e);if(!t)throw Error(`帮助层缺少 #${e} 元素`);return t}var ql=class{fpsEl;messageEl;constructor(){this.fpsEl=Jl(`hud-fps`),this.messageEl=Jl(`hud-message`)}setFps(e){this.fpsEl.textContent=`FPS: ${e.toFixed(0)}`}setScore(e,t){Jl(`hud-score`).textContent=`${e} : ${t}`}setMode(e){Jl(`hud-mode`).textContent=e===`bare`?`模式：空手`:`模式：键盘+持物`}showMessage(e){this.messageEl.textContent=e,this.messageEl.classList.remove(`error`),this.messageEl.hidden=!1}showError(e){this.messageEl.textContent=e,this.messageEl.classList.add(`error`),this.messageEl.hidden=!1}clearMessage(){this.messageEl.hidden=!0}};function Jl(e){let t=document.getElementById(e);if(!t)throw Error(`HUD 缺少 #${e} 元素`);return t}var Yl=33,Xl=new URLSearchParams(location.search),Zl=Xl.get(`debug`)===`1`,Ql=Xl.get(`tutorial`)!==`0`;async function $l(){let t=document.getElementById(`app`);if(!t)throw Error(`找不到 #app 容器`);let n=new ql,r=new xl(t,n);r.start();let i=new d,a=new s,o=new Il(i);Zl&&o.toggle();let c=new f(i.params.swingSpeedThreshold*.6),l=new pl,u=new cl(r.world.player),m=new Ol(r.world.shuttle,{player:{x:_l.x,y:_l.y,z:_l.z},ai:{x:vl.x,y:vl.y,z:vl.z}}),g=new fl(r.world.ai,m);o.addSliders([{label:`AI反应 (ms)`,min:0,max:600,step:20,get:()=>g.params.reactionMs,set:e=>{g.params.reactionMs=e}},{label:`AI失误率`,min:0,max:.5,step:.01,get:()=>g.params.missRate,set:e=>{g.params.missRate=e}},{label:`球速(秒/趟)`,min:1,max:2.5,step:.1,get:()=>m.flightTime,set:e=>{m.flightTime=e}}]);let _=`menu`,y=new Nl,b=`bare`,x=new Set,S=document.getElementById(`tutorial-overlay`),C=document.getElementById(`tutorial-canvas`),w=document.getElementById(`tutorial-prompt`),T=Array.from(document.querySelectorAll(`#tutorial-dots span`)),E={showHand:0,grip:1,doubleGrip:2,ready:3,done:3},D=null,O=e=>{D?.(),D=null,e&&(D=Ul(C,e,2))},k=()=>{n.clearMessage(),S.hidden=!1,w.textContent=y.prompt;let e=E[y.step];T.forEach((t,n)=>t.classList.toggle(`active`,n<=e)),O(y.sketch)},A=()=>{S.hidden=!0,O(null)},j=()=>{b=`bare`,n.setMode(b),y.reset(),_=`tutorial`,k()},ee=new Gl(j),M=0,te=e=>{l.hit(e),r.addShake(Math.min(.18,.06+e*.02)),M=1};u.onStrike=(e,t)=>{_===`playing`&&(m.tryHit(`player`)?te(t):l.whiff())},g.onResolve=e=>{e&&_===`playing`&&l.hit(1.6)},m.onPoint=(e,t)=>{n.setScore(t.player,t.ai),l.point(e)},m.onMatchEnd=(e,t)=>{_=`matchEnd`;let i=e===`player`;n.showMessage(`${i?`你赢了！`:`AI 获胜`}  ${t.player} : ${t.ai}\n按 R 再来一局 · C 换赛制`),r.world.player.setMood(i?`celebrate`:`defeat`),r.world.ai.setMood(i?`defeat`:`celebrate`)},m.onContact=e=>{_===`playing`&&(e===`net`?l.net():l.bounce())};let N=document.getElementById(`format-overlay`),ne=document.getElementById(`format-quick`),re=document.getElementById(`format-standard`),ie=6,ae=()=>{_=`menu`,r.world.player.setMood(`idle`),r.world.ai.setMood(`idle`),n.clearMessage(),N.hidden=!1},oe=(e=ie)=>{ie=e,l.ensure(),m.match.winScore=ie,m.reset(),n.setScore(0,0),r.world.player.setMood(`idle`),r.world.ai.setMood(`idle`),N.hidden=!0,_=`playing`,n.clearMessage()};ne.addEventListener(`click`,e=>{e.stopPropagation(),oe(6)}),re.addEventListener(`click`,e=>{e.stopPropagation(),oe(21)}),window.addEventListener(`keydown`,e=>{if(l.ensure(),x.add(e.code),e.code===`Backquote`){o.toggle();return}if(e.code===`KeyH`||e.code===`F1`){e.preventDefault(),ee.toggle();return}if(e.code===`KeyM`){b=b===`bare`?`keyboard`:`bare`,n.setMode(b),c.reset();return}e.code===`Space`?(e.preventDefault(),_===`menu`?oe():_===`tutorial`?y.skip():_===`playing`?(_=`paused`,n.showMessage(`已暂停
空格 继续 · R 重开`)):_===`paused`&&(_=`playing`,n.clearMessage())):e.code===`KeyR`&&_!==`menu`&&_!==`tutorial`?oe():e.code===`KeyC`&&_===`matchEnd`&&ae()}),window.addEventListener(`pointerdown`,()=>{l.ensure(),_===`menu`?oe():_===`tutorial`&&y.skip()}),window.addEventListener(`keyup`,e=>{x.delete(e.code)});let P=new e;n.showMessage(`正在请求摄像头权限…
请在浏览器弹窗中点击"允许"。`);try{await P.start()}catch(e){n.showError(e instanceof Error?e.message:String(e));return}let se=document.getElementById(`cam-preview`);se?.prepend(P.video),se?.addEventListener(`click`,e=>{e.stopPropagation(),se.classList.toggle(`large`)}),n.showMessage(`摄像头已就绪，正在加载手部追踪模型…`);let F;try{F=await v.create()}catch(e){n.showError(e instanceof Error?e.message:String(e));return}console.info(`[tracking] delegate = ${F.delegate}`),y.onStepChange=e=>{e===`done`?(A(),ae()):k()},Ql?j():ae();let I=0,ce=Yl,le=0,ue=0,de=0,fe=0,pe=null,me=null,he=0;F.onResult=(e,t,n)=>{if(pe=e,ue++,le=le===0?t:le*.7+t*.3,ce=Math.min(250,Math.max(Yl,le*1.5)),e){let t=i.addSample({t:n/1e3,x:e.palm.x,y:e.palm.y,confidence:e.confidence});t&&(me=t,o.flashSwing(),_===`playing`&&b===`keyboard`&&u.swing({direction:`right`,speed:t.speed,time:t.time}),_===`tutorial`&&u.swing(t));let s=b===`bare`?a.update(e.landmarks,n/1e3):null;s&&_===`tutorial`&&y.onGrip(s.double),s&&_===`playing`&&(s.double?m.smash()&&(u.jumpSmash(),l.hit(3.5),r.addShake(.16),M=1.6):u.swing({direction:`right`,speed:2.2,time:s.t}))}else i.onLost(),a.update(null,n/1e3)},r.onFrame=e=>{let t=performance.now();if(P.ready&&t-I>=ce&&(I=t,F.submit(P.video,t)),_===`playing`){u.update(e),g.update(e),m.update(e);let t=r.world.player.group.position;if(b===`keyboard`){let n=!!x.has(`KeyD`)-+!!x.has(`KeyA`),r=!!x.has(`KeyS`)-+!!x.has(`KeyW`);if(n!==0||r!==0){let i=Math.hypot(n,r);t.x+=n/i*p.speed*e,t.z+=r/i*p.speed*e,t.x=Math.max(_l.x-p.x,Math.min(_l.x+p.x,t.x)),t.z=Math.max(_l.z-p.z,Math.min(_l.z+p.z,t.z)),m.updateHome(`player`,{x:t.x,y:0,z:t.z})}}else{let n=Math.hypot(i.velocity.x,i.velocity.y);c.update(pe?{x:pe.palm.x,y:pe.palm.y,size:eu(pe)}:null,n,e,a.isFist);let r=h(c.pos,{x:_l.x,z:_l.z},c.sizeRatio),o=r.x-t.x,s=r.z-t.z,l=Math.hypot(o,s);if(l>1e-4){let n=Math.min(l,p.speed*e);t.x+=o/l*n,t.z+=s/l*n,m.updateHome(`player`,{x:t.x,y:0,z:t.z})}}}else if(_===`tutorial`){u.update(e),y.update(e,pe!==null);let t=Math.hypot(i.velocity.x,i.velocity.y);c.update(pe?{x:pe.palm.x,y:pe.palm.y,size:eu(pe)}:null,t,e,a.isFist)}M>0&&(M=Math.max(0,M-e*6),r.world.shuttle.group.scale.setScalar(1+M*.6)),de+=e,de>=.5&&(fe=ue/de,ue=0,de=0),o.drawOverlay(pe),o.visible&&(he+=e,he>=.2&&(he=0,o.updateStats({renderFps:r.currentFps,trackingFps:fe,delegate:F.delegate,inferMs:le,detectIntervalMs:ce,confidence:pe?.confidence??null,velocity:i.velocity,cooldownActive:i.cooldownActive(t/1e3),lastSwing:me})))}}$l().catch(e=>{console.error(e)});function eu(e){let t=e.landmarks[0],n=e.landmarks[9];return Math.hypot(t.x-n.x,t.y-n.y)}